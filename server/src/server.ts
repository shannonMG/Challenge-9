...
app.use(routes); // using the app.use method to mount middleware to our app, in this case the routes, which reffers to the routes we imported from index.js on line 6
